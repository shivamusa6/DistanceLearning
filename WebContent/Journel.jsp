...
<!--  <marquee direction="up" scrollamount="9"><font name="century gothic" size=5 color="red"><strong>***Journals will be uploaded shortly!!!</strong></font></marquee>
-->

<marquee direction="up" scrollamount="9"><a href="images/Fresher Application form.pdf"><font name="century gothic" size=5 color="red"><strong>***Journals will be uploaded shortly!!!</strong></font></a></marquee>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p><br>
  <br>
