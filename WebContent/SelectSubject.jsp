...
<form action="SelectsubServlet" method="post">
        <table>
        <tr>
        <td>
        <select name="s1">
        ...
        <br></br>
         ...
         <tr><td><input type="submit" value="Start your Test" style="width:100px; height:40px; color:blue;"/></td></tr>
       </table>
