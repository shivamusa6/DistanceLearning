...
function fx()
 ...
 if(document.f1.d1.selectedIndex==0)
     ...
     if(document.f1.r[0].checked==false && document.f1.r[1].checked==false)
     {
      ...
      if(document.f1.ty[0].checked==false && document.f1.ty[1].checked==false)
     {
         alert("Choose Type Option ");
         document.f1.ty[0].focus();
          return false;
     }
     f1.submit();
  }
...
<form action="RegistrationServlet" name="f1" method="post" onSubmit="return fx()">
<div class="page-out">
<div class="page-in">
<div class="page">
<div class="main">
...
<div class="mainmenu">
<h2 class="sidebar1">E-Learning</h2>
<iframe width="320" height="480" src="https://www.youtube.com/embed/sxUQsKxcOYM" frameborder="0" allowfullscreen></iframe>
</div>
