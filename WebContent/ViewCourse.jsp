...
<form action="#" method="post">
    ...
    <h3> Select student ID</h3>
     ...
     <%
     String subb=request.getParameter("s1");
     String sql="select * from subjectdetails where subname=?";
     PreparedStatement ps1=con.prepareStatement(sql);
     ps1.setString(1, subb);
     ...
     %>  
			 ...
			 <tr align="center">
			 	...
			 	<th>
			 		...
			 		<th>
			 		<label><%= rs1.getString(5)%></label>
			 		</th>
			 		<th>
			 		 <label><%= rs1.getString(6)%></label>
			 		</th>
			 		<th>
			 		 <label><%= rs1.getString(7)%></label>
			 		</th>
			 		<th>
			 		 <label><%= rs1.getString(8)%></label>
			 		</th>
			 		<th>
			 		 <label><%= rs1.getString(9)%></label>
			 		</th>
...
<ul>
  ...
  <li><a href="Download.jsp">Download Lectures</a></li>
