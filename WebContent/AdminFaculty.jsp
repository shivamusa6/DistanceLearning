...
<p>&nbsp;</p>-->
	...
	<% 
			...
			ArrayList h=Dao.fac_list("select userid, email, name, address, dob, phone, gender, dept, degree, design, salary from facultydetails");
			if(h.size()!=0)
			{
			 %>
...
<ul>
  ...
  <li><a href="AdminFaculty.jsp">Subject Materials</a></li>
...
<p><strong>Address :</strong> Lorem Ipsum has been the<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;dummy
text the 1500s,</p>
